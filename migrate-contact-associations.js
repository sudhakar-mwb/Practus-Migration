...
/**
 * Migrates Contact associations (Contact<->Company, Contact<->Deal,
 * Contact<->Contact) from the source HubSpot portal to the destination
 ...
 * this file and migrate-company-associations.js / migrate-deal-associations.js)
 ...
 *
 * USAGE:
 *   node --env-file=.env migrate-contact-associations.js
 *
...
if (require.main === module) {
  migratePrimaryObjectAssociations('contacts').catch((err) => {
